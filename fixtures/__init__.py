...
def import_example_data():
    ...
    label_countries_map = {"international": label_int, "Austria": label_at, "Germany": label_de}
    logo_map = {
        ...
        "Rainforest Alliance": {lang: "https://ucarecdn.com/8111e8bb-2ce9-4d57-af34-272e20acb16c/"},
        ...
        "UTZ Cacao": {
            lang: "https://ucarecdn.com/f64d0875-3de2-4dff-a46e-ea0bc0d4bd31/"
        },  # same as UTZ
        ...
        "Natürlich für uns": {lang: "https://ucarecdn.com/aad93ae5-cbf4-4199-82ef-25455acd5d26/"},
        "Natur aktiv": {lang: "https://ucarecdn.com/a2c47e54-29fd-4fc7-ba84-56f667c21132/"},
        ...
        "Tierwohl kontrolliert": {
            lang: "https://ucarecdn.com/27292a9d-6ac6-4e32-840f-2e6b1a698832/"
        },  # 2 ticks
    ...
    with open(os.path.dirname(__file__) + "/csvs/criteria-labels.csv") as csv_file:
        ...
        for row in reader:
            ...
            criterion = Criterion.query.filter(
                Criterion.name[lang].astext == criterion_name
            ).first()
            if criterion is None:
                subcategory = CriterionCategory.query.filter(
                    CriterionCategory.name[lang].astext == subcategory_name
                ).first()
                if subcategory is None:
                    category = CriterionCategory.query.filter(
                        CriterionCategory.name[lang].astext == category_name
                    ).first()
                    if category is None:
    ...
    if unknown_labels:
        print(
            "Couldn’t apply criteria scores to unknown labels:\n'{}'\n".format(
                "', '".join(unknown_labels)
            )
        )
    db.session.commit()
    ...
    if unknown_criteria:
        print(
            "Couldn’t map hotspots to unknown critera:\n'{}'\n".format(
